...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.format'
        db.alter_column(u'catalog_item', 'format_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.MediaFormat']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Item.format'
        db.alter_column(u'catalog_item', 'format_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.ItemFormat']))
    ...
    models = {
        ...
        u'catalog.item': {
            ...
            'format': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['catalog.MediaFormat']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
