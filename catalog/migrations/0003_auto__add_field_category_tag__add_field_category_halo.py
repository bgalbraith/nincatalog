...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'catalog_category', 'tag',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Category.halo'
        db.add_column(u'catalog_category', 'halo',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'catalog_category', 'tag')

        # Deleting field 'Category.halo'
        db.delete_column(u'catalog_category', 'halo')
