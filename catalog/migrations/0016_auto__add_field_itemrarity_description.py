...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemRarity.description'
        db.add_column(u'catalog_itemrarity', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemRarity.description'
        db.delete_column(u'catalog_itemrarity', 'description')
