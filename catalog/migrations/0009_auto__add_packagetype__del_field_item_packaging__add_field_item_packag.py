...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Item.packaging'
        db.delete_column(u'catalog_item', 'packaging')

        # Adding field 'Item.package_type'
        db.add_column(u'catalog_item', 'package_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['catalog.PackageType']),
                      keep_default=False)

        # Adding field 'Item.package_notes'
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Item.packaging'
        db.add_column(u'catalog_item', 'packaging',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)
    ...
    models = {
        ...
        u'catalog.item': {
            ...
            'package_notes': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'package_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['catalog.PackageType']"}),
