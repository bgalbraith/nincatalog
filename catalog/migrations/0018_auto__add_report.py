...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Report'
        db.create_table(u'catalog_report', (
            ...
            ('n_columns', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=3)),
            ('column_width', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'catalog', ['Report'])


    def backwards(self, orm):
        # Deleting model 'Report'
        db.delete_table(u'catalog_report')
